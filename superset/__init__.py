...
#backendSync = '/static/assets/backendSync.json'
backendSync = '/assets/backendSync.json'

with open(APP_DIR + backendSync, 'r') as f:
...
def get_manifest_file(filename):
    ...
    return 'http://127.0.0.1:9090/' + manifest.get(filename, '')
